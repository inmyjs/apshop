...
$(document).ready(function(){
	...
	//init /public/red/images/views lightbox view
	if($('.prettyphoto')[0]){
	...
	if($('#bg-slideshow')[0]){
		$('#bg-slideshow').kenburns({
			images:[
			"/public/red/images/bg-slideshow/1.jpg",
			"/public/red/images/bg-slideshow/2.jpg",
			"/public/red/images/bg-slideshow/3.jpg"
			],
	...
	if(style == null) {
		$('#custom-style').attr('href', '/public/red/css/styles/red.css');
		$('#logo img').attr('src', '/public/red/images/logo-red.png');
	}else{
		$('#custom-style').attr('href', '/public/red/css/styles/'+style+'.css');
		$('#logo img').attr('src', '/public/red/images/logo-'+style+'.png');
	}
